...
if __name__ == "__main__":
    ...
    with gr.Blocks(title="Yamini's AI Assistant", theme=gr.themes.Soft(primary_hue="blue", secondary_hue="slate", font=["Inter", "sans-serif"])
                   ) as demo:
        gr.Markdown("""
        ...
        chat = gr.ChatInterface(me.chat, type="messages")
